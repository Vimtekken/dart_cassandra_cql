...
class EventRegistrationType extends Enum<String> {
  static const EventRegistrationType TOPOLOGY_CHANGE =
      const EventRegistrationType._("TOPOLOGY_CHANGE");
  static const EventRegistrationType STATUS_CHANGE =
      const EventRegistrationType._("STATUS_CHANGE");
  static const EventRegistrationType SCHEMA_CHANGE =
      const EventRegistrationType._("SCHEMA_CHANGE");
