  ...
  group("Simple connection pool:", () {
    ...
    group("misc:", () {
      test("empty hosts exception", () {
        expect(
            () => new cql.SimpleConnectionPool.fromHostList(
                [], new cql.PoolConfiguration()),
            throwsA((e) =>
                e is ArgumentError &&
                e.message == "Host list cannot be empty"));
      });

      test("Client with default pool conf", () {
        client = new cql.Client.fromHostList(["${SERVER_HOST}:${SERVER_PORT}"]);
        expect(
            client!.connectionPool.poolConfig!.connectionsPerHost, equals(1));
      });
    ...
    group("authentication:", () {
      group("password authenticator exceptions", () {
        test("empty username", () {
          expect(() => new cql.PasswordAuthenticator("", "foo"),
              throwsArgumentError);
        });
      ...
      test("User/pass mismatch exception", () {
        server
            .setAuthReplayList(["authenticate_v3.dump", "auth_error_v3.dump"]);
      ...
      test("Auth success (multi challenge-response)", () {
        ...
        client!.query(new cql.Query("SELECT * FROM test.test_type")).then(
            expectAsync(handleSuccess) as FutureOr<void> Function(
    ...
    group("execute:", () {
      ...
      test("set keyspace", () {
        ...
        void handleResult(cql.ResultMessage message) {
          ...
          expect((message as cql.SetKeyspaceResultMessage).keyspace,
              equals("test"));
        }

        client!.execute(new cql.Query("USE test")).then(
            expectAsync(handleResult) as FutureOr<void> Function(
                ResultMessage?));
      });
      ...
      test("alter statement and process raw RowsResultMessage", () {
        ...
        expect(
          ...
          cql.SchemaChangeResultMessage res =
        ...
        group("custom types:", () {
          test("without custom type handler", () {
            ...
            client!
                ...
                .then(expectAsync(onResult) as FutureOr<void> Function(
                    Iterable<Map<String?, Object?>>?));
          });

          test("with custom type handler", () {
            // Register custom type handler
            cql.registerCodec('com.achilleasa.cassandra.cqltypes.Json',
    ...
    group("stream:", () {
        ...
        void streamCallback(Map<String?, Object?> row) {
          if (firstInvocation) {
            ...
            server.shutdown().then((_) {
              new Future.delayed(
                  new Duration(milliseconds: 10), () => subscription.resume());
            });
          }
        }
      ...
      test("connection lost; fallback to alt connection", () {
        ...
        client = new cql.Client.fromHostList(["${SERVER_HOST}:${SERVER_PORT}"],
            poolConfig: new cql.PoolConfiguration(
                autoDiscoverNodes: false, connectionsPerHost: 2));
...
INSERT INTO test.type_test (
  ...
  :ascii_type, :bigint_type, :decimal_type, :bool_type,
	...
	:varchar_type, :varint_type, :blob_type
        ...
        client!
            .execute(query)
            .then(expectAsync(done) as FutureOr<void> Function(ResultMessage?));
      });
  ...
  :ascii_type, :bigint_type, :decimal_type, :bool_type,
	...
	:varchar_type, :varint_type, :blob_type
      ...
      test(
        ...
        client = new cql.Client.fromHostList(
            ["${SERVER_HOST}:${SERVER_PORT}", "${SERVER_HOST}:${SERVER2_PORT}"],
            poolConfig: new cql.PoolConfiguration(
                autoDiscoverNodes: false, connectionsPerHost: 2));
      ...
      group("STATUS_CHANGE (V2):", () {
        test(
          ...
          cql.PoolConfiguration poolConfig = new cql.PoolConfiguration(
              ...
              reconnectWaitTime: new Duration(
                  milliseconds: 0) // Keep reconnect time low for our test
              );
          client = new cql.Client.fromHostList(
              ["${SERVER_HOST}:${SERVER_PORT}"],
        ...
        test(
          ...
          cql.PoolConfiguration poolConfig = new cql.PoolConfiguration(
              autoDiscoverNodes: true,
              reconnectWaitTime: new Duration(
                  milliseconds: 1) // Keep reconnect time low for our test
              );
          client = new cql.Client.fromHostList(
          ...
          group("KEYSPACE:", () {
            test("created", () {
              ...
              void handleMessage(cql.EventMessage message) {
                expect(message.type,
                    equals(cql.EventRegistrationType.SCHEMA_CHANGE));
              ...
              client!.connectionPool.listenForServerEvents([
                cql.EventRegistrationType.SCHEMA_CHANGE
                  ...
                  expectAsync(handleMessage) as void Function(EventMessage)?);
              ...
              client!.connectionPool.connect().then((_) {
                ...
                return new Future.delayed(
                    ...
                    () => server.replayFile(
                        0, "event_schema_created_keyspace_v2.dump"));
              });
            });
            ...
            test("dropped", () {
              ...
              client!.connectionPool.connect().then((_) {
                ...
                return new Future.delayed(
                    new Duration(milliseconds: 100),
                    () => server.replayFile(
                        0, "event_schema_dropped_keyspace_v2.dump"));
              });
            });
          });
            ...
            test("created", () {
              ...
              client!.connectionPool.connect().then((_) {
                ...
                return new Future.delayed(
                    new Duration(milliseconds: 100),
                    () => server.replayFile(
                        0, "event_schema_created_table_v2.dump"));
              });
            });
            ...
            test("dropped", () {
              ...
              client!.connectionPool.connect().then((_) {
                ...
                return new Future.delayed(
                    new Duration(milliseconds: 100),
                    () => server.replayFile(
                        0, "event_schema_dropped_table_v2.dump"));
              });
            });
            ...
            test("updated", () {
              ...
              client!.connectionPool.connect().then((_) {
                ...
                return new Future.delayed(
                    new Duration(milliseconds: 100),
                    () => server.replayFile(
                        0, "event_schema_updated_table_v2.dump"));
              });
            });
          });
        });
          ...
          test("created", () {
            ...
            client!.connectionPool.connect().then((_) {
              ...
              return new Future.delayed(
                  new Duration(milliseconds: 100),
                  () => server.replayFile(
                      0, "event_schema_created_keyspace_v3.dump"));
            });
          });
          ...
          test("dropped", () {
            ...
            client!.connectionPool.connect().then((_) {
              ...
              return new Future.delayed(
                  new Duration(milliseconds: 100),
                  () => server.replayFile(
                      0, "event_schema_dropped_keyspace_v3.dump"));
            });
          });
        });
          ...
          test("created", () {
            ...
            client!.connectionPool.connect().then((_) {
              ...
              return new Future.delayed(
                  new Duration(milliseconds: 100),
                  () => server.replayFile(
                      0, "event_schema_created_table_v3.dump"));
            });
          });
          ...
          test("dropped", () {
            ...
            client!.connectionPool.connect().then((_) {
              ...
              return new Future.delayed(
                  new Duration(milliseconds: 100),
                  () => server.replayFile(
                      0, "event_schema_dropped_table_v3.dump"));
            });
          });
          ...
          test("updated", () {
            ...
            client!.connectionPool.connect().then((_) {
              ...
              return new Future.delayed(
                  new Duration(milliseconds: 100),
                  () => server.replayFile(
                      0, "event_schema_updated_table_v3.dump"));
            });
          });
        });
          ...
          test("created", () {
            ...
            client!.connectionPool.connect().then((_) {
              ...
              return new Future.delayed(
                  new Duration(milliseconds: 100),
                  () => server.replayFile(
                      0, "event_schema_created_type_v3.dump"));
            });
          });
          ...
          test("dropped", () {
            ...
            client!.connectionPool.connect().then((_) {
              ...
              return new Future.delayed(
                  new Duration(milliseconds: 100),
                  () => server.replayFile(
                      0, "event_schema_dropped_type_v3.dump"));
            });
          });
          ...
          test("updated", () {
            ...
            client!.connectionPool.connect().then((_) {
              ...
              return new Future.delayed(
                  new Duration(milliseconds: 100),
                  () => server.replayFile(
                      0, "event_schema_updated_type_v3.dump"));
            });
          });
        });
      });
